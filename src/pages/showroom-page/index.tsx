    ...
    return (
        <div className={styles.adaptiveContainer}>
            <div className={styles.optionsContainer}>
                {data.items.map((element, index) => (
                    <CalloutOption
                        key={index}
                        icon={
                            <svg xmlns="http://www.w3.org/2000/svg" width={70 - 15} height={70 - 15} fill="currentColor" className="bi bi-android2" viewBox="0 0 16 16">
            ...
            <div className={styles.modelContainer}>
                <div>
                    <HexagonGroupGridLayout
                        icon="icon-url"
                        sizeSegments={100}
                        xAxis={3}
                        yAxis={3}
                        imageURL={"./../../assets/img/background/dima-gait-ns2-6-fp0012.jpg"} // Передаем imageURL как пропс
                    />
                </div>
            </div>
